...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    //driver always on
    objDriveTrain.setDefaultCommand(new DriveRobot(() -> -objXboxDriverStick.getRawAxis(1) * 0.9 * (1.0 - objXboxDriverStick.getRawAxis(2)),
      () -> objXboxDriverStick.getRawAxis(4) * 0.9 * (1.0 - objXboxDriverStick.getRawAxis(2)), objDriveTrain)
      );
